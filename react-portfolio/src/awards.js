        ...
        <div>
            <div class="row">
                <div style={{ margin: 0 + ' auto',  padding: 15 + "px"}} class="col text-center left-block green-block round-corners  bg-kinda-dark btn-margin-20">
                    ...
                    <hr/>
                    <iframe src="/StrategioCert.pdf#zoom=50" width="640" height="480" allow="autoplay"></iframe>
                </div>
            </div>
            <hr/>
            <div class="row">
                    ...
                    <hr/>
                    <iframe src="/hack-a-roo_certificate.pdf#zoom=50" width="640" height="480" allow="autoplay"></iframe>
                </div>
            </div>
        </div>
    )
